  ...
  return (
    ...
    >
      <DrawerContent direction={direction}>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DrawerDescription className="text-xs text-gray-500 mt-0.5">
                  Our AI-powered evaluation framework
                </DrawerDescription>
              </div>
            </div>

            {/* X close — right drawer only */}
            {direction === 'right' && (
              <button
                onClick={onClose}
                aria-label="Close"
        ...
        {/* Accessibility: provide title + description for DrawerContent (vaul/radix requirement) */}
        ...
        <DrawerBody className="space-y-5">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <strong className="text-gray-800">4,000+ high-quality circular economy projects</strong>
            .
          </p>
            ...
            {METHODOLOGY_ITEMS.map((item, idx) => (
              ...
              >
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                  <span className="text-sm font-bold text-gray-800 leading-snug">{item.title}</span>
          ...
          >
            <TriangleAlert className="size-4 text-amber-500 shrink-0 mt-0.5" strokeWidth={1.75} />
            <p className="text-xs text-gray-600 leading-relaxed">
