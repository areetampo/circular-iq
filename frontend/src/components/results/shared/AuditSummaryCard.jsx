/** Audit summary card for result, assessment, and comparison views. */
...
/**
 * Renders available audit sections such as integrity gaps, strengths, recommendations, and roadmap.
 */
