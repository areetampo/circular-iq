...
export default function HeaderModalManager({ modal, isModalOpen, closeModal }) {
  if (!modal) return null;

  switch (modal.type) {
    case HEADER_MODALS.ASSESSMENT_METHODOLOGY:
      return <AssessmentMethodologyModal isModalOpen={isModalOpen} closeModal={closeModal} />;

    case HEADER_MODALS.EVALUATION_CRITERIA:
      return <EvaluationCriteriaModal isModalOpen={isModalOpen} closeModal={closeModal} />;
