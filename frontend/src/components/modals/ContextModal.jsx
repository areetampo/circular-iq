...
export default function ContextModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-3xl overflow-hidden duration-200 bg-white shadow-2xl rounded-2xl animate-in zoom-in-95"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header - Clean with just title */}
        <div className="p-6 bg-gradient-to-r from-emerald-500 to-teal-600">
          <h2 className="m-0 text-2xl font-bold text-white">{title || 'Full Context'}</h2>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(85vh-120px)]">
          ...
          {hasSeparateSections ? (
            ...
            <>
              ...
              {/* Close button - appears right after content */}
              <div className="flex justify-end mt-6">
                <button
                  onClick={onClose}
                  className="px-5 py-2 text-sm font-semibold text-white transition-colors border-none rounded-lg cursor-pointer bg-emerald-600 hover:bg-emerald-700"
