import AssessmentMethodologyModal from '@/components/modals/landing/AssessmentMethodologyModal';
import EvaluationCriteriaModal from '@/components/modals/landing/EvaluationCriteriaModal';
