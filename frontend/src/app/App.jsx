...
import { createAssessment, scoreAssessment } from '@/features/assessments/api/assessmentApi';
...
export default function App() {
  ...
  async function submit() {
    ...
    try {
      const data = await scoreAssessment({
        businessProblem,
        businessSolution,
        parameters,
      });
      ...
      >
        <Routes>
          ...
          <Route
            ...
            element={<AssessmentComparisonPage onBack={() => navigate(-1)} />}
          />
