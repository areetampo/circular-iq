...
import { categorizeIntegrityGaps } from '../../../src/utils/helpers';
import { exportAssessmentCSV, exportAssessmentPDF } from '../../../src/utils/exportSimple';
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div style={{ fontSize: '0.85rem', color: '#e65100', fontWeight: 700 }}>Focus Area</div>
          ...
          {gaps.length > 0 && (
            <div className="gaps-group">
              ...
              <div className="gap-items">
                {gaps.map((gap, i) => (
                  <div key={i} className={`integrity-gap gap-severity-${gap.severity || 'medium'}`}>
