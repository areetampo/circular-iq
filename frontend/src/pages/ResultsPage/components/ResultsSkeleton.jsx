    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="my-8 space-y-4 px-4 sm:px-6">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <Skeleton className="h-8 w-32" /> {/* My Assessments */}
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Skeleton className="h-8 w-20" /> {/* Save */}
            <Skeleton className="h-8 w-24" /> {/* Rename */}
            <Skeleton className="h-8 w-20" /> {/* Delete */}
          </div>
        </div>
      ...
      <div id="results-content" className="mx-auto max-w-7xl space-y-6 px-0 sm:px-6">
        ...
        <div className="mt-8 pt-8">
          <div className="mb-1 h-8 w-48" />
          <Skeleton className="mb-1 h-10 w-20" />
