        ...
        <div className="border-t border-(--color-border) pt-6 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            <div className="border-r border-(--color-border) pr-8">
              <SharedGapAnalysisCard result={scoringResult1} variant="transparent" />
            </div>
            <div className="pl-8">
              <SharedGapAnalysisCard result={scoringResult2} variant="transparent" />
            </div>
          </div>
        </div>
