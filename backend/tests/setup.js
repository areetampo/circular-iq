...
const GLOBAL_TIMEOUT = 300000; // 5 minutes - increased to prevent hanging during full test runs
...
// Make clearGlobalTimeout available globally for the test runner
global.clearGlobalTimeout = clearGlobalTimeout;
